// This code is a copy the objects.c file with added functionality
...
typedef struct SnekObject {
    ...
    int refcount; // Update for the Refcounting GC
} snek_object_t;
...
snek_object_t *new_snek_vector3(
    ...
    refcount_inc(x); // Update to refcount
    refcount_inc(y); // Update to refcount
    refcount_inc(z); // Update to refcount
    return obj;
}
...
// Here starts the Refcounting GC
